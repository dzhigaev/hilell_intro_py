...
first_num = int(random() * 100)
second_num = int(random() * 100)

if first_num % 2 and second_num % 2 or first_num % 2 == 0 and second_num % 2 == 0:
    first_num += 1
...
def my_function(var_x):
    if var_x > 0:
        return 2 * var_x - 10
    if var_x < 0:
        return 2 * abs(var_x) - 1
    if var_x == 0:
        return 0
